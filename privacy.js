...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <main className={styles.mainSinglePage}>

      <p className={styles.titlePage}>Privacy</p>

        <p className={styles.TextLight}>
          Your privacy is important to us. It's Gusto's policy to respect your
          privacy regarding any information we may collect from you across our
          website, Gusto, and other sites we own and operate. We only ask for
          personal information when we truly need it to provide a service to
          you. We collect it by fair and lawful means, with your knowledge and
          consent. We also let you know why we’re collecting it and how it will
          be used. We only retain collected information for as long as necessary
          ...
          publicly or with third-parties. Our website may link to external sites
          that are not operated by us. Please be aware that we have no control
          over the content and practices of these sites, and cannot accept
          responsibility or liability for their respective privacy policies. You
